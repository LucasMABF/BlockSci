...
ParserConfiguration<FileTag>::ParserConfiguration(const blocksci::DataConfiguration &dataConfig,
                                                  const ChainDiskConfiguration &diskConfig)
...
ParserConfiguration<RPCTag>::ParserConfiguration(const blocksci::DataConfiguration &dataConfig,
                                                 const blocksci::ChainRPCConfiguration &rpc)
    : ParserConfigurationBase(dataConfig), config(rpc) {
}
