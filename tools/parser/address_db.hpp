...
template <blocksci::DedupAddressType::Enum type> struct ParserIndexScriptInfo<AddressDB, type> : std::false_type {};

template <> struct ParserIndexScriptInfo<AddressDB, blocksci::DedupAddressType::MULTISIG> : std::true_type {};
...
public:
  ...
  template <blocksci::DedupAddressType::Enum type> void processScript(uint32_t, const blocksci::ScriptAccess &);
...
template <>
inline void AddressDB::processScript<blocksci::DedupAddressType::MULTISIG>(uint32_t equivNum,
                                                                           const blocksci::ScriptAccess &scripts) {
  ...
  for (const auto &addressNum : multisig->addresses) {
    addAddressNested(blocksci::RawAddress{addressNum, blocksci::AddressType::MULTISIG_PUBKEY},
                     blocksci::DedupAddress{equivNum, blocksci::DedupAddressType::MULTISIG});
  }
}
