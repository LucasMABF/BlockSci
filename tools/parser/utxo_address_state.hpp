...
template <blocksci::AddressType::Enum addressType> class UTXOAddressTypeState {
...
public:
  ...
  template <blocksci::AddressType::Enum type> SpendData<type> spendOutput(const blocksci::InoutPointer &outputPointer) {
