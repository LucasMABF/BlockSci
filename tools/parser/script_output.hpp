...
template <blocksci::AddressType::Enum type> struct ScriptOutput {
...
struct ScriptOutputDataBase {
  ...
  template <typename Func> void visitWrapped(Func) {
  }

  template <typename Func> void visitWrapped(Func) const {
  }
};

template <> struct ScriptOutputData<blocksci::AddressType::Enum::PUBKEY> : public ScriptOutputDataBase {
...
template <> struct ScriptOutputData<blocksci::AddressType::Enum::PUBKEYHASH> : public ScriptOutputDataBase {
...
template <> struct ScriptOutputData<blocksci::AddressType::Enum::MULTISIG_PUBKEY> : public ScriptOutputDataBase {
  static constexpr bool maybeUpdate = true;
...
template <> struct ScriptOutputData<blocksci::AddressType::Enum::WITNESS_PUBKEYHASH> : public ScriptOutputDataBase {
...
template <> struct ScriptOutputData<blocksci::AddressType::Enum::SCRIPTHASH> : public ScriptOutputDataBase {
  blocksci::uint160 hash;
...
template <> struct ScriptOutputData<blocksci::AddressType::Enum::WITNESS_SCRIPTHASH> : public ScriptOutputDataBase {
  static constexpr bool maybeUpdate = true;
...
template <> struct ScriptOutputData<blocksci::AddressType::Enum::MULTISIG> : public ScriptOutputDataBase {
  ...
  template <typename Func> void visitWrapped(Func func) {
    for (auto &pubkey : addresses) {
      func(pubkey);
    }
  }

  template <typename Func> void visitWrapped(Func func) const {
    for (auto &pubkey : addresses) {
      func(pubkey);
    }
  }
...
template <> struct ScriptOutputData<blocksci::AddressType::Enum::NONSTANDARD> : public ScriptOutputDataBase {
...
template <> struct ScriptOutputData<blocksci::AddressType::Enum::NULL_DATA> : public ScriptOutputDataBase {
...
template <> struct ScriptOutputData<blocksci::AddressType::Enum::WITNESS_UNKNOWN> : public ScriptOutputDataBase {
