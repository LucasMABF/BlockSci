...
BlockSciDoctor::BlockSciDoctor(filesystem::path _configFilePath)
    : configFilePath(_configFilePath), config(blocksci::loadBlockchainConfig(_configFilePath.str(), true, 0)),
      jsonConf(blocksci::loadConfig(configFilePath.str())) {
