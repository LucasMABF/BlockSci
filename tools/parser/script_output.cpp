...
static bool MatchMultisig(const CScriptView &script,
                          ScriptOutputData<blocksci::AddressType::Enum::MULTISIG> &multisig) {
  opcodetype opcode;
  valtype data;
...
ScriptOutputDataType extractScriptData(const blocksci::CScriptView &scriptPubKey, bool p2shActivated,
...
AnyScriptOutput::AnyScriptOutput(const blocksci::CScriptView &scriptPubKey, bool p2shActivated, bool witnessActivated)
    : wrapped(mpark::visit(ScriptOutputGenerator(), extractScriptData(scriptPubKey, p2shActivated, witnessActivated))) {
}
...
ScriptOutputData<blocksci::AddressType::Enum::PUBKEY>::ScriptOutputData(
    const ranges::subrange<const unsigned char *> &vch1) {
  pubkey.fill(0);
...
blocksci::PubkeyData ScriptOutputData<blocksci::AddressType::Enum::PUBKEY>::getData(uint32_t txNum,
                                                                                    bool topLevel) const {
...
blocksci::PubkeyData ScriptOutputData<blocksci::AddressType::Enum::PUBKEYHASH>::getData(uint32_t txNum,
                                                                                        bool topLevel) const {
...
ScriptOutputData<blocksci::AddressType::Enum::MULTISIG_PUBKEY>::ScriptOutputData(
    const ranges::subrange<const unsigned char *> &vch1) {
  std::copy(vch1.begin(), vch1.end(), pubkey.begin());
}
...
blocksci::PubkeyData ScriptOutputData<blocksci::AddressType::Enum::MULTISIG_PUBKEY>::getData(uint32_t txNum,
                                                                                             bool topLevel) const {
  blocksci::PubkeyData data{txNum, pubkey};
...
blocksci::PubkeyData ScriptOutputData<blocksci::AddressType::Enum::WITNESS_PUBKEYHASH>::getData(uint32_t txNum,
                                                                                                bool topLevel) const {
  blocksci::PubkeyData data{txNum, hash};
...
blocksci::ScriptHashData ScriptOutputData<blocksci::AddressType::Enum::SCRIPTHASH>::getData(uint32_t txNum,
                                                                                            bool topLevel) const {
...
blocksci::ScriptHashData
ScriptOutputData<blocksci::AddressType::Enum::WITNESS_SCRIPTHASH>::getData(uint32_t txNum, bool topLevel) const {
  blocksci::ScriptHashData data{txNum, hash, blocksci::RawAddress{0, blocksci::AddressType::Enum::NONSTANDARD}};
...
void ScriptOutputData<blocksci::AddressType::Enum::MULTISIG>::addAddress(
    const ranges::subrange<const unsigned char *> &vch1) {
...
blocksci::ArbitraryLengthData<blocksci::MultisigData>
ScriptOutputData<blocksci::AddressType::Enum::MULTISIG>::getData(uint32_t txNum, bool topLevel) const {
...
ScriptOutputData<blocksci::AddressType::Enum::NONSTANDARD>::ScriptOutputData(const blocksci::CScriptView &script_)
    : script(script_) {
}

blocksci::ArbitraryLengthData<blocksci::NonstandardScriptData>
ScriptOutputData<blocksci::AddressType::Enum::NONSTANDARD>::getData(uint32_t txNum, bool topLevel) const {
...
blocksci::ArbitraryLengthData<blocksci::RawData>
ScriptOutputData<blocksci::AddressType::Enum::NULL_DATA>::getData(uint32_t txNum, bool topLevel) const {
...
ScriptOutputData<blocksci::AddressType::Enum::WITNESS_UNKNOWN>::ScriptOutputData(
    uint8_t witnessVersion_, const ranges::subrange<const unsigned char *> &witnessData_)
    : witnessVersion(witnessVersion_) {
  witnessData.assign(witnessData_.begin(), witnessData_.end());
}

blocksci::ArbitraryLengthData<blocksci::WitnessUnknownScriptData>
ScriptOutputData<blocksci::AddressType::Enum::WITNESS_UNKNOWN>::getData(uint32_t txNum, bool topLevel) const {
