...
namespace blocksci {
  ...
  protected:
    ...
    void SetData(const std::vector<unsigned char> &vchVersionIn, const unsigned char *pbegin,
  ...
  public:
    ...
    CBitcoinAddress(const std::string &strAddress, unsigned int nVersionBytes) {
      SetString(strAddress, nVersionBytes);
    }
