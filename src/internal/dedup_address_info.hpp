...
namespace blocksci {
  template <DedupAddressType::Enum> struct DedupAddressInfo;

  template <> struct DedupAddressInfo<DedupAddressType::PUBKEY> {
    ...
    static constexpr std::array<AddressType::Enum, 4> equivTypes = {
        {AddressType::PUBKEY, AddressType::PUBKEYHASH, AddressType::MULTISIG_PUBKEY, AddressType::WITNESS_PUBKEYHASH}};
    static constexpr AddressType::Enum reprType = AddressType::PUBKEYHASH;
  };

  template <> struct DedupAddressInfo<DedupAddressType::SCRIPTHASH> {
    static constexpr char name[] = "scripthash_script";
    static constexpr bool equived = true;
    static constexpr bool spendable = true;
    static constexpr bool indexed = false;
    static constexpr std::array<AddressType::Enum, 2> equivTypes = {
        {AddressType::SCRIPTHASH, AddressType::WITNESS_SCRIPTHASH}};
    static constexpr AddressType::Enum reprType = AddressType::SCRIPTHASH;
  };

  template <> struct DedupAddressInfo<DedupAddressType::MULTISIG> {
  ...
  template <> struct DedupAddressInfo<DedupAddressType::NONSTANDARD> {
  ...
  template <> struct DedupAddressInfo<DedupAddressType::NULL_DATA> {
  ...
  template <> struct DedupAddressInfo<DedupAddressType::WITNESS_UNKNOWN> {
  ...
  template <DedupAddressType::Enum type> struct SpendableFunctor {
  ...
  template <DedupAddressType::Enum type> struct EquivedFunctor {
    static constexpr bool f() {
  ...
  template <DedupAddressType::Enum type> struct DedupAddressTypesFunctor {
