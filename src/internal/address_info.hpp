...
namespace blocksci {
  ...
  template <AddressType::Enum> struct AddressInfo;

  template <> struct AddressInfo<AddressType::PUBKEY> {
  ...
  template <> struct AddressInfo<AddressType::PUBKEYHASH> {
  ...
  template <> struct AddressInfo<AddressType::MULTISIG_PUBKEY> {
  ...
  template <> struct AddressInfo<AddressType::WITNESS_PUBKEYHASH> {
  ...
  template <> struct AddressInfo<AddressType::SCRIPTHASH> {
  ...
  template <> struct AddressInfo<AddressType::WITNESS_SCRIPTHASH> {
  ...
  template <> struct AddressInfo<AddressType::NONSTANDARD> {
  ...
  template <> struct AddressInfo<AddressType::NULL_DATA> {
  ...
  template <> struct AddressInfo<AddressType::WITNESS_UNKNOWN> {
  ...
  template <AddressType::Enum type> struct DedupAddressTypeFunctor {
