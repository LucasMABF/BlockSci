...
namespace blocksci {
   ...
   *
   *    ColumnDescriptors: Every AddressType as its name and "_output" as a suffix. @see blocksci::AddressType::all()
   * @see blocksci::addressName() Eg. "pubkey_output", "pubkeyhash_output", "multisig_pubkey_output" etc.
   *
   *    Key/value format:
   ...
   *    The two places this occurs are with p2sh addresses wrapping other addresses and with multisig addresses
   * containing pubkeys.
   *
   *    ColumnDescriptors: Every AddressType as its name and "_nested" as a suffix. @see blocksci::AddressType::all()
   * @see blocksci::addressName() Eg. "pubkey_nested", "pubkeyhash_nested", "multisig_pubkey_nested" etc.
   *
   *    Key/value format:
  ...
  class AddressIndex {
    ...
    /** RocksDB column handles, one for every AddressType and the suffixes "_nested" and "_output", see above for
     * details */
