...
template <ranges::category range_cat, typename Class> void addProxyMapFuncsMethodsCore(Class &cl) {
  using namespace blocksci;
  cl.def("_map", mapSimple<range_cat, Block>)
...
template <ranges::category range_cat, typename Class> void addProxyMapFuncsMethodsScripts(Class &cl) {
  using namespace blocksci;
  cl.def("_map", mapSimple<range_cat, script::Pubkey>)
...
template <ranges::category range_cat, typename Class> void addProxyMapFuncsMethodsOther(Class &cl) {
  using namespace blocksci;
  cl.def("_map", mapSimple<range_cat, AddressType::Enum>)
