...
template <typename Class> void addSelfProxy(Class &cl) {
  using T = typename Class::type;
  cl.def_property_readonly_static("_self_proxy", [](pybind11::object &) -> Proxy<T> { return makeSimpleProxy<T>(); });
}

template <typename T> void addAnyInit(py::class_<std::any> &cl) {
  cl.def(py::init([](T &val) -> std::any { return val; }))
...
PYBIND11_MODULE(_blocksci, m) {
  ...
  py::class_<Blockchain> blockchainCl(
      m, "Blockchain",
      "Class representing the blockchain. This class is constructed by passing it a string representing a file path to "
      "your BlockSci data files generated by blocksci_parser",
      py::dynamic_attr());
  ...
  py::class_<ScriptBase> addressCl(m, "Address",
  ...
  py::class_<script::PubkeyHash> pubkeyHashAddressCl(m, "PubkeyHashAddress", addressCl,
                                                     "Extra data about pay to pubkey address");
  py::class_<script::WitnessPubkeyHash> witnessPubkeyHashAddressCl(m, "WitnessPubkeyHashAddress", addressCl,
                                                                   "Extra data about pay to pubkey address");
  py::class_<script::MultisigPubkey> multisigPubkeyCl(m, "MultisigPubkey", addressCl,
                                                      "Extra data about a pubkey inside a multisig address");
  ...
  py::class_<script::WitnessUnknown> witnessUnknownCl(m, "WitnessUnknownAddress", addressCl,
                                                      "Data about an unknown witness address");
  ...
  py::class_<GenericAddressIterator, GenericIterator> genericAddressIteratorCl(
      m, "GenericAddressIterator", "Class representing any Address iterator");
  py::class_<GenericAddressRange, GenericRange> genericAddressRangeCl(m, "GenericAddressRange",
  ...
  RangeClasses<script::WitnessPubkeyHash> witnessPubkeyHashRangeCls(
      createAddressRangeClasses<script::WitnessPubkeyHash>(m));
