...
void init_pubkey(py::class_<script::Pubkey> &cl) {
  cl.def("__repr__", &script::Pubkey::toString).def("__str__", &script::Pubkey::toPrettyString);
}

void init_pubkeyhash(py::class_<script::PubkeyHash> &cl) {
  cl.def("__repr__", &script::PubkeyHash::toString).def("__str__", &script::PubkeyHash::toPrettyString);
}

void init_witness_pubkeyhash(py::class_<script::WitnessPubkeyHash> &cl) {
  cl.def("__repr__", &script::WitnessPubkeyHash::toString).def("__str__", &script::WitnessPubkeyHash::toPrettyString);
}

void init_multisig_pubkey(py::class_<script::MultisigPubkey> &cl) {
  cl.def("__repr__", &script::MultisigPubkey::toString).def("__str__", &script::MultisigPubkey::toPrettyString);
}
