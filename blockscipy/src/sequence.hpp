...
template <typename T> struct Range : public Sequence<T>, public GenericRange {
...
template <> struct Range<blocksci::AnyScript> : public Sequence<blocksci::AnyScript>, public GenericAddressRange {
...
struct Range<blocksci::ScriptAddress<type>> : public Sequence<blocksci::ScriptAddress<type>>,
                                              public GenericAddressRange {
...
template <typename T> struct Iterator : public Sequence<T>, public GenericIterator {
  ranges::any_view<T> rng;

  template <typename R> Iterator(R &&r) : rng(std::forward<R>(r)) {
  }
...
template <> struct Iterator<blocksci::AnyScript> : public Sequence<blocksci::AnyScript>, public GenericAddressIterator {
  using T = blocksci::AnyScript;
  ranges::any_view<T> rng;
...
template <blocksci::AddressType::Enum type>
struct Iterator<blocksci::ScriptAddress<type>> : public Sequence<blocksci::ScriptAddress<type>>,
                                                 public GenericAddressIterator {
  using T = blocksci::ScriptAddress<type>;
  ranges::any_view<T> rng;
