...
using BlocksciRangeTypeVariant = mpark::variant<
    RawRange<blocksci::Block>, RawRange<blocksci::Transaction>, RawRange<blocksci::Input>, RawRange<blocksci::Output>,
    RawRange<blocksci::AnyScript>, RawRange<blocksci::EquivAddress>, RawRange<blocksci::Cluster>,
    RawRange<blocksci::TaggedCluster>, RawRange<blocksci::TaggedAddress>, RawRange<blocksci::script::Pubkey>,
