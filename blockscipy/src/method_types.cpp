...
template <typename T>
void addTypeName(std::unordered_map<std::type_index, std::string> &type_names,
                 std::unordered_map<std::type_index, std::string> &docstring_type_names, const std::string &name,
                 bool isBlocksci = true, std::string module = "") {
