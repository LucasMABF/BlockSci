...
template <typename T> struct RangeClasses {
...
template <blocksci::AddressType::Enum type> struct RangeClasses<blocksci::ScriptAddress<type>> {
  pybind11::class_<Sequence<blocksci::ScriptAddress<type>>> sequence;
  pybind11::class_<Iterator<blocksci::ScriptAddress<type>>, Sequence<blocksci::ScriptAddress<type>>,
                   GenericAddressIterator>
      iterator;
  pybind11::class_<Range<blocksci::ScriptAddress<type>>, Sequence<blocksci::ScriptAddress<type>>, GenericAddressRange>
      range;
};

template <> struct RangeClasses<blocksci::AnyScript> {
