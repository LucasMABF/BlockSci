...
struct AddOutputMethods {
  template <typename FuncApplication> void operator()(FuncApplication func) {
    ...
    func(property_tag, "spending_tx_index", &Output::getSpendingTxIndex,
         "Returns the index of the tranasction which spent this output or 0 if it is unspent");
    func(property_tag, "spending_tx", &Output::getSpendingTx,
         "The transaction that spent this output or None if it is unspent");
    func(property_tag, "spending_input", &Output::getSpendingInput,
