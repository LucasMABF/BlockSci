...
struct AddBlockMethods {
  template <typename FuncApplication> void operator()(FuncApplication func) {
    ...
    func(property_tag, "time_seen", &Block::getTimeSeen,
         "If recorded by the mempool recorder, the time that this block was first seen by your node");
    func(property_tag, "timestamp_seen", &Block::getTimestampSeen,
    ...
    func(
        property_tag, "coinbase_param",
        +[](const Block &block) -> py::bytes { return py::bytes(block.coinbaseParam()); },
    ...
    func(
        property_tag, "revenue", +[](const Block &block) -> int64_t { return totalOutputValue(block[0]); },
    ...
    func(property_tag, "input_value", totalInputValue<Block &>,
         "Returns the sum of the value of all of the inputs included in this block");
    func(property_tag, "output_value", totalOutputValue<Block &>,
         "Returns the sum of the value of all of the outputs included in this block");
    func(
        property_tag, "tx_count", +[](const Block &block) -> int64_t { return block.size(); },
