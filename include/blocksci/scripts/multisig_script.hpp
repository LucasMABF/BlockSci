...
namespace blocksci {
  template <> class BLOCKSCI_EXPORT ScriptAddress<AddressType::MULTISIG> : public ScriptBase {
  private:
  ...
  public:
    ...
    ScriptAddress(uint32_t addressNum_, const MultisigData *data_, DataAccess &access_)
        : ScriptBase(addressNum_, addressType, access_, data_) {
    }
    ...
    ranges::any_view<script::MultisigPubkey, ranges::category::random_access | ranges::category::sized>
    pubkeyScripts() const;
  };
} // namespace blocksci
