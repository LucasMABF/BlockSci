...
namespace blocksci {
  template <> class BLOCKSCI_EXPORT ScriptAddress<AddressType::NULL_DATA> : public ScriptBase {
  ...
  public:
    ...
    ScriptAddress(uint32_t addressNum_, const RawData *data_, DataAccess &access_)
