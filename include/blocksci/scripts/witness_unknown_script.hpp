...
namespace blocksci {
  template <> class BLOCKSCI_EXPORT ScriptAddress<AddressType::WITNESS_UNKNOWN> : public ScriptBase {
  ...
  public:
    ...
    ScriptAddress(uint32_t scriptNum_,
                  std::tuple<const WitnessUnknownScriptData *, const WitnessUnknownSpendScriptData *> &&rawData_,
                  DataAccess &access_)
