...
namespace blocksci {
  namespace heuristics {
    ...
    std::pair<std::vector<Transaction>, std::vector<Transaction>> BLOCKSCI_EXPORT
    getPossibleCoinjoinTransactions(Blockchain &chain, int64_t minBaseFee, double percentageFee, std::size_t maxDepth);
  } // namespace heuristics
} // namespace blocksci
