...
namespace blocksci {
  struct BLOCKSCI_EXPORT AddressType {
    ...
    enum Enum {
// After preprocessing: NONSTANDARD, PUBKEY, PUBKEYHASH, MULTISIG_PUBKEY, SCRIPTHASH, MULTISIG, NULL_DATA,
// WITNESS_PUBKEYHASH, WITNESS_SCRIPTHASH, WITNESS_UNKNOWN
#define VAL(x) x
      ADDRESS_TYPE_LIST
#undef VAL
    };
 ...
 * std::integral_constant<Enum, PUBKEYHASH>, std::integral_constant<Enum, MULTISIG_PUBKEY>, std::integral_constant<Enum,
 * SCRIPTHASH>, std::integral_constant<Enum, MULTISIG>, std::integral_constant<Enum, NULL_DATA>,
 * std::integral_constant<Enum, WITNESS_PUBKEYHASH>, std::integral_constant<Enum, WITNESS_SCRIPTHASH>,
 * std::integral_constant<Enum, WITNESS_UNKNOWN> >;
 */
