...
namespace blocksci {
  ...
  std::vector<Transaction> BLOCKSCI_EXPORT getTransactions(const std::vector<OutputPointer> &pointers,
                                                           DataAccess &access);
  std::vector<Transaction> BLOCKSCI_EXPORT getOutputTransactions(const std::vector<OutputPointer> &pointers,
                                                                 DataAccess &access);
  std::vector<Transaction> BLOCKSCI_EXPORT getInputTransactions(const std::vector<OutputPointer> &pointers,
                                                                DataAccess &access);
} // namespace blocksci
