...
namespace blocksci {
  ...
  public:
    ...
    public:
      ...
      difference_type operator-(const self_type &it) const {
        return static_cast<difference_type>(tx.txNum - it.tx.txNum);
      }
  ...
  inline TransactionRange::iterator::self_type BLOCKSCI_EXPORT operator+(TransactionRange::iterator::difference_type i,
                                                                         const TransactionRange::iterator &it) {
    return it + i;
  }
} // namespace blocksci
